...
function Footer() {
  return (
    <div  style={{height:'300px',width:'100%'}} className=' mt-5 bg-primary'>
    <div className=" container w-100 footer-content d-flex justify-content-between pt-4">
        <div style={{width:'400px'}} className="title ">
            <h5  style={{color:'white'}} className='d-flex'><i class="fa-solid fa-truck-fast me-2" style={{height:'45px'}}></i>
            E-Cart</h5>
        ...
        <div className="links d-flex flex-column">
            ...
            <Link to={'/cart'} style={{color:'white'}} className='text-decoration-none' href="" >Cart</Link>
            <Link to={'/wishlist'} style={{color:'white'}} className='text-decoration-none' href="" >Wishlist</Link>
        </div>
